        ...
        <table className="w-full">
          <thead className="sticky top-0 bg-[var(--color-bg)] z-10">
            <tr style={{ borderBottom: '2px solid var(--color-border)' }}>
              ...
              <th className="text-right py-3 pr-4 text-sm font-semibold text-[var(--color-textMuted)]">High Score</th>
              <th className="text-right py-3 pr-4 text-sm font-semibold text-[var(--color-textMuted)]">W-L</th>
